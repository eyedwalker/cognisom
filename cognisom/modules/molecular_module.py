...
from cognisom.engine.py.molecular.nucleic_acids import Gene, RNA, NucleicAcidType, Mutation
from cognisom.engine.py.molecular.exosomes import ExosomeSystem
...
class MolecularModule(SimulationModule):
    ...
    def _create_gene_library(self):
        ...
        """
        from cognisom.engine.py.molecular.reference_cds import (
