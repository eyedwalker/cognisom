                    ...
                    profile = PatientProfile(
                        ...
                        predicted_neoantigens=[
                            Neoantigen(
                                ...
                                mutation_position_in_peptide=4,
                                peptide_length=len(n["peptide"]),
                                ...
                                is_strong_binder=n.get("is_strong_binder", n.get("binding_affinity_nm", n.get("ic50_nm", 999)) < 50),
                                is_weak_binder=n.get("is_weak_binder", n.get("binding_affinity_nm", n.get("ic50_nm", 999)) < 500),
                                binding_level=n.get("binding_level", "weak"),
                                agretopicity=n.get("agretopicity", 1.0),
                                vaccine_priority=i+1,
                                include_in_vaccine=n.get("include_in_vaccine", False),
                            )
