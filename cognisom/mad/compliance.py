    ...
    steps: List[Dict[str, Any]] = field(default_factory=lambda: [
        ...
        },
        {
            ...
            "assessment": (
                ...
                "429-patient SU2C ANALYTICAL validation -- agreement with the "
                "cohort's own reported annotations, not prediction of patient "
                "outcomes, which this study does not test: "
                "TMB r=0.9998 vs reported TMB_NONSYNONYMOUS (n=427), "
                "TMB-H sensitivity/specificity 1.00/1.00 at 10 mut/Mb, "
                "HRD detection sensitivity/specificity 1.00/1.00 (n=429, "
                "95 positive), ground truth taken from MAF Hugo_Symbol and "
                "Variant_Classification independently of the pipeline. "
                "Reproduced by tests/test_su2c_validation.py. "
